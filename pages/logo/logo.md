...
Het logo wordt voornamelijk in de originele huisstijlkleuren gebruikt. Indien een donkere achtergrond, felle kleur of om welke andere reden het niet geschikt is om de huisstijlkleuren te gebruiken, kan het logo in 1 kleur gebruikt worden. Positief wordt gebruikt als de huisstijlkleuren niet beschikbaar zijn (vb. printen in zwart-wit)?
Negatief wordt gebruikt als de huisstijlkleuren niet tot zijn recht komen (vb. donkere achtergrond, patronen, afbeeldingen)
<img src="images/voorbeelden/LogoPosNeg" class="img-fluid" alt="Responsive image">
